...
function getchat(lastchatid){
 ...
 getTopTopianTimer();
function getTopTopianTimer(){
        var countDownDate = top_topian_jstimestamp;
        var y = setInterval(function() {
            ...
            $("#topTopianCountDown").html(hours + ": " + minutes + ": " + seconds);
        
            // If the count down is over, write some text 
            if (distance < 0) {
                clearInterval(y);
                $("#topTopianCountDown").html("EXPIRED");
            }
        }, 1000); 
}
   getEventTimer();
function getEventTimer(){
        var countDownDate = 1570208400000;
        var y = setInterval(function() {
            // Get todays date and time
            var now = new Date().getTime();
            // Find the distance between now and the count down date
...
/** top vouchers board **/
function topVouchersBoard(){
    $.get(API_URL + "voucherMinters.php", function(data, status,xhr){		
            if(xhr.status==200){
            data = JSON.parse(data);		
            if(data.result==true){		
                var resultminers = data.data;		
                ...
                var counterX = 0;		
                var rankVariable;		
                var vouchersLeaderboardHTML = ' <li class="head-at"> <div class="row">  <div class="col-md-2 col-sm-2 col-xs-2">      <div class="head-th">   <p>Rank</p>   </div>   </div>   <div class="col-md-5 col-sm-5 col-xs-5">    <div class="head-th">         <p>Player</p>     </div>      </div>     <div class="col-md-3 col-sm-3 col-xs-3">   <div class="head-th">     <p>Minted</p>  </div>     </div>     <div class="col-md-2 col-sm-2 col-xs-2">     <div class="head-th">    <p>Prize</p>   </div>   </div>    </div>  </li>';		
                $.each(resultminers, function(key, obj) {		
                    ...
                    user = '<span style="color:'+color+'">'+user+level+'</span>';		
                    vouchersLeaderboardHTML += ' <li class="dt-tbs">     <div class="row">    <div class="col-md-2 col-sm-2 col-xs-2">    '+ rankVariable +'  </div>   <div class="col-md-5 col-sm-5 col-xs-5">      <div class="head-th">   <p> '+ user +' </p>    </div>     </div>  <div class="col-md-3 col-sm-3 col-xs-3">   <div class="head-th">   <p>'+ obj.vouchers +'</p>    </div>    </div>   <div class="col-md-2 col-sm-2 col-xs-2">   <div class="head-th poit"> '+payOutText+'    </div>   </div>   </div>   </li> ';		
                        		
                   		
                    counterX++;		
                });		
                		
                $("#vouchersLeaderboard").html(vouchersLeaderboardHTML); 		
...
/** top losers board **/
function topLosersBoard(){
    $.get(API_URL + "unluckyLoosers.php", function(data, status,xhr){		
            if(xhr.status==200){
            data = JSON.parse(data);		
            if(data.result==true){		
                var resultminers = data.data;		
                ...
                var counterX = 0;		
                var rankVariable;		
                var loosersLeaderboardHTML = ' <li class="head-at"> <div class="row">  <div class="col-md-2 col-sm-2 col-xs-2">      <div class="head-th">   <p>Rank</p>   </div>   </div>   <div class="col-md-5 col-sm-5 col-xs-5">    <div class="head-th">         <p>Player</p>     </div>      </div>     <div class="col-md-3 col-sm-3 col-xs-3">   <div class="head-th">     <p>Lose</p>  </div>     </div>     <div class="col-md-2 col-sm-2 col-xs-2">     <div class="head-th">    <p>Prize</p>   </div>   </div>    </div>  </li>';		
                $.each(resultminers, function(key, obj) {		
                    ...
                    user = '<span style="color:'+color+'">'+user+level+'</span>';		
                    loosersLeaderboardHTML += ' <li class="dt-tbs">     <div class="row">    <div class="col-md-2 col-sm-2 col-xs-2">    '+ rankVariable +'  </div>   <div class="col-md-5 col-sm-5 col-xs-5">      <div class="head-th">   <p> '+ user +' </p>    </div>     </div>  <div class="col-md-3 col-sm-3 col-xs-3">   <div class="head-th">   <p>'+ obj.total +' TRX</p>    </div>    </div>   <div class="col-md-2 col-sm-2 col-xs-2">   <div class="head-th poit"> '+payOutText+'    </div>   </div>   </div>   </li> ';		
                        		
                   		
                    counterX++;		
                });		
                		
                $("#loosersLeaderboard").html(loosersLeaderboardHTML); 		
