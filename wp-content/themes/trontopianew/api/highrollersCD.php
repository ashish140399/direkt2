...
$sql = "SELECT * from highrollers_classicDice where timestamp>".$timestamp." order by timestamp DESC limit 0,50";
//$sql = "SELECT * FROM highrollers_rollDice ORDER BY timestamp DESC LIMIT 50";
