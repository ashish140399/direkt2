...
$(document).ready(async function() {
    ...
    const MAX_SIDEBET_AMOUNT = 50000;
...
try {
  ...
  //  $('#closeNotSignIn').click(function(){$("#notSignIn").hide();});
    ...
    async function trxTopiaFunc(){
        var voucherMintRate = await voucherContractInstance.mintingBasePrice(ultimateDiceContractAddress).call();
...
$('#withdrawReferralBonus').click(async function(){
    ...
    $('#withdrawTopiaBtn').click(async function(){
        ...
        var availableTopia =  tokenContractInstance.displayAvailabletoWithdrawTOPIA().call();
